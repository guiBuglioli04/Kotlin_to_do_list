...
import carreiras.com.github.todolist.combinarDataHora
import carreiras.com.github.todolist.data.Tarefa
import carreiras.com.github.todolist.extrairDataDoDatePicker
import carreiras.com.github.todolist.paraMillisUtcDoDatePicker
...
fun FormularioTarefaScreen(
    ...
    FormularioTarefaContent(
        ...
        onExcluir = {
            tarefaExistente?.let { viewModel.deletar(it) }
            onVoltar()
        },
        onVoltar = onVoltar
    )
